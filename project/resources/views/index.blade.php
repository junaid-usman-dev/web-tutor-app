      ...
      <div class="main_img">
        <div class="container ">
          <div class="row p-0 m-0">
              ...
              <h1 class="text-left p-0 m-0"><img src="{{ asset('theme_asset/home/images/main_img.png') }}" class="img-fluid">
            </div>
            <div class="col-md-6">
				<div class="margin-desk">
              <h1 class="text-center heading_color_blue " ><strong>LEARN</strong> on your terms from an expert tutor.</h1>
              <p class="text-center txt_med">Private, 1–on–1 lessons with the expert instructor of your choice. You decide when to meet, how much to pay, and who you want to work with.</p>
              <p>&nbsp;</p>
              <p class="text-center"><a class="btn btn-info" href="#">Get Help &nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a></p>
					</div>
            </div>
          </div>
        </div>
      ...
      <div class="container m_bott80 ">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12 text-center">
            <img class="rounded-circle img_border img_shadow" alt="200x200" style="width: 200px; height: 200px;" src="{{ asset('theme_asset/home/images/blk_1.jpg') }}" data-holder-rendered="true">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 text-center">
            <img class="rounded-circle img_border img_shadow" alt="200x200" style="width: 200px; height: 200px;" src="{{ asset('theme_asset/home/images/blk_2.jpg') }}" data-holder-rendered="true">
            <h3 class="heading_color_blue">THE RIGHT FIT.</h3>
            <p class="txt_small">Find an expert who suits your needs<br>
and learning style</p>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 text-center">
           <img class="rounded-circle img_border img_shadow" alt="200x200" style="width: 200px; height: 200px;" src="{{ asset('theme_asset/home/images/blk_3.jpg') }}" data-holder-rendered="true">
...
1-to-1 lessons.</p>
        ...
        <div class="container">
          <div class="row">
            <div class="text-left col-md-9 col-12 mx-auto">
				<div class="row">
				<div class="col-md-3"><img src="{{ asset('theme_asset/home/images/gaurantee_badge.png') }}"></div>
              <div class="col-md-9"><p class="lead m_top30"><strong>Find the right fit or it’s FREE.</strong></p>
				<p class="txt_norm">We guarantee you’ll find the right tutor, or we’ll cover the first hour of your lesson.</p></div></div>
            </div>
          </div>
	...
	<h2 class="text-center mb-1 heading_color_blue"><span>Don’t just take our word for it. See what students have to say...</span><br>
	...
	<div class="carousel-inner m_bott80">
		<div class="carousel-item active">
			<div class="testi-text-wrap">
				<h2 class="txt_med text-center">Isaac is a very good tutor. I was failing a class I needed to pass <br>
      ...
      <div class="container">
        <div class="row">
			...
			<h3>GET TO KNOW US</h3>
				<p><a href="#">Find A Tutor</a>     <a href="#">How it Works</a>      <a href="#">Resources</a>      <a href="#">Start Tutoring</a>      <a href="#">About Us</a> </p>
		  ...
		  <div class="col-md-4 f_mlinks"><h3>LET'S KEEP IN TOUCH</h3>
			  <p><a href="#"><i class="fab fa-facebook-square fa-2x"></i></a> <a href="#"><i class="fab fa-instagram-square fa-2x"></i></a> <a href="#"><i class="fab fa-twitter-square fa-2x"></i></a> <a href="#"><i class="fab fa-linkedin fa-2x"></i></a></p>
		    <h3>FEELING LOST?</h3>
				<p class="txt_small" style="color: #879dc0;">Give us a call: <strong style="color: #fff">(312) 646-6365</strong> <br> or  <br>
					Write to us:   <a href="mailto:info@TutorLynx.com">info@TutorLynx.com</a></p>
			
			</div>
			
			
			  <div class="col-md-2 text-center"><img src="{{ asset('theme_asset/home/images/footer_logo.png') }}"></div>
