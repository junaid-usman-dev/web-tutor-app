	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form class="login100-form validate-form" method="POST" action="{{ action('Test\TestController@store') }}" >
                    @csrf
					...
					<div class="wrap-input100 validate-input m-b-16" >
						<input class="input100 @error('name') is-invalid @enderror" type="text" id="name" name="name" placeholder="Test Name">
					</div>
                    @error('name')
