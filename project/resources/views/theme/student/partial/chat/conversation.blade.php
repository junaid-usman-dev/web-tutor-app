        ...
        @if ($messenger->sender_id != $user->id)
            ...
            <div class="direct-chat-msg">
                <div class="direct-chat-infos clearfix">
                    ...
                    <span class="direct-chat-timestamp float-right">{{ \Carbon\Carbon::parse($messenger->created_at)->format('d M g:i A') }}
                        </span>
                </div>
                <!-- /.direct-chat-infos -->
        ...
        @else
            ...
            <div class="direct-chat-msg right">
                <div class="direct-chat-infos clearfix">
                    ...
                    <span class="direct-chat-timestamp float-left">{{ \Carbon\Carbon::parse($messenger->created_at)->format('d M g:i A') }}
                        </span>
                </div>
                <!-- /.direct-chat-infos -->
                <img class="direct-chat-img"
