    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Tutor Result</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Tutor Result</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tutor Result</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form">
                                                    ...
                                                    @foreach ($user->tests as $test)
                                                        <p>
                                                            ...
                                                            <span class="float-right" >
                                                                <span class="ju-result-p-right">Score: {{ $test->pivot->score }}% </span>
                                                                @if ( $test->pivot->score >= 50 )
                                                                    <span> <strong>PASS</strong></span>
                                                                @else
                                                                    <span> <strong>Fail</strong></span>
                                                                @endif  
